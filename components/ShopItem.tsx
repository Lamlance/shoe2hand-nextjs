...
class ShopItem extends React.Component<ShopItemData,{}>{
    ...
    render(): React.ReactNode {
        return(<div className={styles["ShopItemWrapper"]}>
            <img alt={"Product img desc"} ></img>
            <h3>Item no.{this.props.name}</h3>
            <button ref={this.addCartButton} onClick={()=>{this.addToCartHandler()}}>Add to cart</button>
        </div>)
    }
}
